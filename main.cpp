...
int main(int argc, char* argv[]){
    ...
    // and access them through an array of pointers to students
    ...
    // Create 18 teachers (one for each classroom) and access them through an array of pointers to teachers
    ...
    // Memory deallocation for each dynamically allocated block
    for(int i = 0; i < 36; i++){
        delete students[i];
    }
    delete[] students;
    ...
    delete[] teachers;
    for(int i = 0; i < 6; i++){
        delete classrooms1[i];
        delete classrooms2[i];
        delete classrooms3[i];
    }
    delete[] classrooms1;
    delete[] classrooms2;
    delete[] classrooms3;
